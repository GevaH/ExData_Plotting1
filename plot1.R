...
# (only the lines we want) and gives names to the columns.
firstDate             <- "1/2/2007"
lastDate              <- "^2/2/2007"
...
# Plotting part.
png(file = "plot1.png") # Defualt is set to 480 x 480 so I just hadn't specified it.
hist(as.numeric(as.vector(projectData$Global_active_power)), col = "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)")
dev.off()